...
public class MainScreen extends javax.swing.JFrame {
    ...
    private final String mainScreem = "Main Screen";
    private final String SegoeUI = "Segoe UI";
    private final String Word = "Word";
    private final String Meaning = "Meaning";
    private final String Record = "Record";
    private final String Createnewword = "CreateNewWord";
    private final String Save = "Save";
    private final String Inputkeyword = "Input your key Word";
    private final String Create = "Create";
    private final String Dictionary = "Nam Phong Dictionary";
    private final String Myfavoriteword= "My favorite word";
    private final String Statistics= "Statistics";
    private final String Doyouwanttodeletethisword = "Do you want to delete this word?";
    private final String Delete = "Delete";
    private final String Addintoyourfavoritelist = "Add into my Favorite List";
    private final String Ask = "Asking";
    ...
    private final String Adddingsucess = "Addding sucessfully!";
    private final String Info = "Infomation";
    private final String Wordormeaningisempty = "Word or meaning is empty";
